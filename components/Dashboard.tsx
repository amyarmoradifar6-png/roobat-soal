...
export const Dashboard: React.FC<DashboardProps> = ({ subject, chapters, onNavigate, onChapterSelect, onBackToSubjects }) => {
  return (
    <div className="space-y-10 py-4 pb-20 animate-in fade-in slide-in-from-bottom-2 duration-500">
      {/* Back Button */}
      <button 
        onClick={onBackToSubjects}
        className="flex items-center gap-2 text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors font-medium mb-4"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {chapters.map((chapter) => (
          <div 
            ...
            className="group bg-white dark:bg-slate-900 rounded-3xl p-6 md:p-8 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] hover:shadow-xl dark:shadow-none border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden cursor-pointer"
          >
      ...
      <div className="pt-8 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <button 
                ...
                className="bg-sky-50 dark:bg-sky-900/20 border border-sky-100 dark:border-sky-800 p-6 rounded-3xl flex flex-col items-center gap-4 hover:shadow-lg transition-all group h-full"
            >
            ...
            <button 
                ...
                className="bg-rose-50 dark:bg-rose-900/20 border border-rose-100 dark:border-rose-800 p-6 rounded-3xl flex flex-col items-center gap-4 hover:shadow-lg transition-all group h-full"
            >
            ...
            <button 
                ...
                className="bg-orange-50 dark:bg-orange-900/20 border border-orange-100 dark:border-orange-800 p-6 rounded-3xl flex flex-col items-center gap-4 hover:shadow-lg transition-all group h-full"
            >
            ...
            <button 
                ...
                className="bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800 p-6 rounded-3xl flex flex-col items-center gap-4 hover:shadow-lg transition-all group h-full"
            >
